  ...
  return (
    <div className={classes.sidebar}>
      <div className={classes.sidebar__logo}>
        <Image src={logo} className={classes["sidebar__logo--img"]} />
      </div>
      <div className={classes.sidebar__wrapper}>
        <div className={classes.sidebar__top}>
          <Link href="/for-you" className={classes["sidebar__link--wrapper"]}>
            ...
            ></div>
            <div className={classes["sidebar__icon--wrapper"]}>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
                ...
                className={classes["sidebar__icon--svg"]}
              >
          ...
          <Link href="/library" className={classes["sidebar__link--wrapper"]}>
            ...
            <div className={classes["sidebar__link--text"]}>My Library</div>
          </Link>
          <div
            className={`${classes["sidebar__link--wrapper"]} ${classes["sidebar__link--not"]}`}
          >
            <div className={classes["sidebar__link--line"]}></div>
            <div className={classes["sidebar__icon--wrapper"]}>
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <div className={classes["sidebar__link--text"]}>Highlights</div>
          </div>
          <div
            className={`${classes["sidebar__link--wrapper"]} ${classes["sidebar__link--not"]}`}
          >
        ...
        <div className={classes.sidebar__bottom}>
          <Link href="/settings" className={classes["sidebar__link--wrapper"]}>
            ...
            <div className={classes["sidebar__link--text"]}>Settings</div>
          </Link>
          <div
            className={`${classes["sidebar__link--wrapper"]} ${classes["sidebar__link--not"]}`}
          >
            ...
            <div className={classes["sidebar__link--text"]}>Help & Support</div>
          </div>
          <button
            className={classes["sidebar__link--wrapper"]}
            onClick={user.email ? logoutUser : () => dispatch(open())}
          >
            <div className={classes["sidebar__link--line"]}></div>
            <div className={classes["sidebar__icon--wrapper"]}>
              <svg
            ...
            <div className={classes["sidebar__link--text"]}>
